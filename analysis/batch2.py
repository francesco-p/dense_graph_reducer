...
def work(pid, n, d, dset_ids):
    ...
    dset_path = './data/synthetic_graphs'
    csv_path  = './data/synthetic_graphs/csv'

    for dset_id in dset_ids:
        ### 2. ###
        filename = f"{dset_path}/{n}/{n}_{d:.2f}_{dset_id}.npz"
        ...
        if kec == {}:
            ...
            with io.open(f'{csv_path}/{n}.csv', 'a') as f:
...
csv_path  = './data/synthetic_graphs/csv'
with io.open(f'{csv_path}/{n}.csv', 'w') as f:
